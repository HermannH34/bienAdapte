     ...
     <>
      ...
      <div className='flex flex-col sm:flex-row mb-6 mt-6'>
       ...
       <div className="flex items-center mb-2 mt-4 ml-4 mr-4 flex-col">
        ...
        <input {...register("ambiance")} id="calme" type="checkbox" value="calme" className="w-5 mb-2 h-5 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
        <AsyncNextImage
         src="/calme.png"
         width={75}
         height={75}
       ...
       <div className="flex items-center mb-2 mt-4 ml-4 flex-col">
        ...
        <input {...register("ambiance")} id="festive" type="checkbox" value="festive" className="w-5 h-5 mb-2 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
        <AsyncNextImage
         src="/cocktail.png"
         width={75}
         height={75}
