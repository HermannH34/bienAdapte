...
const About = () => {
     ...
     return (
          <main className="max-w-xl mx-auto">
               <div className="pb-12 pt-5 mx-auto">
...
Notre objectif est de vous faire gagner du temps sur la recherche et de vous éviter d’en perdre avec des visites de biens qui ne vous conviennent pas, et ce, sans vous limiter au catalogue de biens d’une agence.
